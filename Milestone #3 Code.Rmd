...
asthma_house_poll <- data.frame("County" = CES_environment_Asthma$County, "CES 4.0 Score" = CES_environment_Asthma$`CES 4.0 Score`, "Pollution Burden Score" = CES_environment_Asthma$`Pollution Burden Score`, "Housing Burden %" = CES_environment_Asthma$`Housing Burden`)

colnames(asthma_house_poll) = c("County", "CES 4.0 Score", "Pollution Burden Score", "Housing Burden %")

summary(asthma_house_poll)
...
#to calculate rate, we need population size number for the strata in each county. backcalculate this number using the methodology of the original data set. once you have this estimated population, recalculate your rate.
